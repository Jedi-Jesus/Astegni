"""
Migration: Add country column to subscription_plans table
Adds GPS-based country detection support to subscription plans
"""
...
def migrate():
    """Add country column to subscription_plans table"""

    with engine.connect() as conn:
        print("Starting migration: Add country column to subscription_plans table")
        ...
        try:
            ...
            conn.execute(text("""
                CREATE INDEX IF NOT EXISTS idx_subscription_plans_country
            ...
            print("\nSubscription plans now support country-specific pricing:")
...
def verify():
    ...
    with engine.connect() as conn:
        ...
        result = conn.execute(text("""
            ...
            AND indexname = 'idx_subscription_plans_country'
        """))

        if result.fetchone():
            print("[OK] Index 'idx_subscription_plans_country' exists")
        else:
