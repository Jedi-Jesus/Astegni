...
(function() {
    ...
    window.viewCourseRequest = async function(requestId) {
        ...
        try {
            ...
            const API_BASE_URL_LOCAL = 'https://api.astegni.com';
            const response = await fetch(`${API_BASE_URL_LOCAL}/api/course-management/requests/${requestId}`);
    ...
    window.approveCourse = async function(requestId) {
        if (confirm(`Are you sure you want to approve course request ${requestId}?`)) {
            ...
            try {
                const response = await fetch(`${API_BASE_URL_LOCAL}/api/course-management/${requestId}/approve`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    }
    ...
    window.rejectCourse = async function(requestId) {
        ...
        if (reason && reason.trim()) {
            ...
            try {
                const response = await fetch(`${API_BASE_URL_LOCAL}/api/course-management/${requestId}/reject`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    window.reconsiderCourse = async function(rejectedId) {
        if (confirm(`Reconsider rejected course ${rejectedId}? This will move it back to pending requests.`)) {
            ...
            try {
                const response = await fetch(`${API_BASE_URL_LOCAL}/api/course-management/${rejectedId}/reconsider`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    }
    ...
    window.viewCourse = async function(courseId) {
        ...
        try {
            ...
            if (courseId.startsWith('CRS-')) {
                // Active course
                endpoint = `${API_BASE_URL_LOCAL}/api/course-management/active/${courseId}`;
            } else if (courseId.startsWith('SUS-CRS-')) {
                // Suspended course
                endpoint = `${API_BASE_URL_LOCAL}/api/course-management/suspended/${courseId}`;
            } else if (courseId.startsWith('REJ-CRS-')) {
                // Rejected course
                endpoint = `${API_BASE_URL_LOCAL}/api/course-management/rejected/${courseId}`;
            } else {
    ...
    window.suspendCourse = async function(courseId) {
        ...
        if (reason && reason.trim()) {
            ...
            try {
                const response = await fetch(`${API_BASE_URL_LOCAL}/api/course-management/${courseId}/suspend`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    window.rejectActiveCourse = async function(courseId) {
        ...
        if (reason && reason.trim()) {
            ...
            try {
                const response = await fetch(`${API_BASE_URL_LOCAL}/api/course-management/${courseId}/reject-active`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    window.reconsiderActiveCourse = async function(courseId) {
        if (confirm(`Reconsider active course ${courseId}? This will move it back to pending requests for re-review.`)) {
            ...
            try {
                const response = await fetch(`${API_BASE_URL_LOCAL}/api/course-management/${courseId}/reconsider-active`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    }
    ...
    window.rejectSuspendedCourse = async function(suspendedId) {
        ...
        if (reason && reason.trim()) {
            ...
            try {
                const response = await fetch(`${API_BASE_URL_LOCAL}/api/course-management/${suspendedId}/reject-suspended`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    window.reconsiderSuspendedCourse = async function(suspendedId) {
        if (confirm(`Reconsider suspended course ${suspendedId}? This will move it back to pending requests for re-review.`)) {
            ...
            try {
                const response = await fetch(`${API_BASE_URL_LOCAL}/api/course-management/${suspendedId}/reconsider-suspended`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    }
    ...
    window.reinstateCourse = async function(suspendedId) {
        if (confirm(`Reinstate course ${suspendedId}? This will make it active again.`)) {
            ...
            try {
                const response = await fetch(`${API_BASE_URL_LOCAL}/api/course-management/${suspendedId}/reinstate`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    }
...
Astegni Team`;
    ...
    window.confirmSendNotification = async function() {
        ...
        try {
            const response = await fetch(`${API_BASE_URL_LOCAL}/api/course-management/${courseId}/notify`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    window.openEditProfileModal = async function() {
        ...
        if (modal) {
            ...
            try {
                const response = await fetch(`${API_BASE_URL_LOCAL}/api/admin-dashboard/profile-stats?admin_id=1`);
                if (response.ok) {
    ...
    window.handleProfileUpdate = async function(event) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL_LOCAL}/api/admin-dashboard/profile?admin_id=1`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function refreshPanelStats() {
        try {
            ...
            const response = await fetch(`${API_BASE_URL_LOCAL}/api/admin-dashboard/panel-statistics/${currentPanel}?force_refresh=true`);
            if (response.ok) {
            ...
            const quotasResponse = await fetch(`${API_BASE_URL_LOCAL}/api/admin-dashboard/daily-quotas?admin_id=1`);
