...
(function() {
    ...
    async function loadDailyQuotas() {
        // Skip - this endpoint doesn't exist yet in the local database
        // TODO: Implement admin_daily_quotas table and endpoint when needed
        console.log('Daily quotas: Using default values (endpoint not implemented)');
    }
    ...
    async function loadAchievements() {
        // Skip - this endpoint doesn't exist yet in the local database
        // TODO: Implement admin_achievements table and endpoint when needed
        console.log('Achievements: Using default values (endpoint not implemented)');
    }
    ...
    async function loadFireStreak() {
        // Skip - this endpoint doesn't exist yet in the local database
        // TODO: Implement admin_fire_streaks table and endpoint when needed
        console.log('Fire streak: Using default values (endpoint not implemented)');
    }
    ...
    async function loadProfileStats() {
        try {
            ...
            // Fetch profile data from astegni_admin_db (admin_profile and manage_courses_profile tables)
    ...
    function updateProfileHeader(profile) {
        ...
        // Update badges from manage_courses_profile
        ...
        // Update location from manage_courses_profile.location array
    ...
    async function loadPanelStatistics(panelName) {
        try {
            ...
            // Skip - this endpoint doesn't exist yet in the local database
            // TODO: Implement panel-statistics endpoint when needed
            console.log(`${panelName} panel statistics: Using default values (endpoint not implemented)`);
    ...
    async function loadRequestedPanelStats() {
        try {
            const response = await fetch(`${API_BASE_URL_LOCAL}/api/admin/courses/stats/by-status`);
