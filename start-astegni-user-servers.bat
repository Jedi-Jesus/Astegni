@echo off
echo ========================================
echo   ASTEGNI USER SERVER RESTART SCRIPT
echo ========================================
echo.
...
echo.
echo To run ADMIN servers separately (for dual login):
echo   Run admin-pages\start-astegni-admin-servers.bat
echo   Admin will use ports 8001/8082
echo.
