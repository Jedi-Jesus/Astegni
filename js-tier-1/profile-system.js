...
function updateProfilePictures() {
    // Determine the default picture path based on protocol
    const defaultPicture = typeof UrlHelper !== 'undefined' && UrlHelper.isFileProtocol
        ? 'http://localhost:8000/pictures/default-avatar.png'
