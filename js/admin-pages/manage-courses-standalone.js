...
window.confirmReject = async function() {
    ...
    try {
        ...
        if (currentCourseActionType === 'request') {
            endpoint = `${API_BASE_URL}/api/course-management/${currentCourseActionId}/reject`;
        } else if (currentCourseActionType === 'active') {
            endpoint = `${API_BASE_URL}/api/course-management/${currentCourseActionId}/reject-active`;
        } else if (currentCourseActionType === 'suspended') {
            endpoint = `${API_BASE_URL}/api/course-management/${currentCourseActionId}/reject-suspended`;
        }
...
window.confirmSuspend = async function() {
    ...
    try {
        ...
        const response = await fetch(`${API_BASE_URL}/api/course-management/${currentCourseActionId}/suspend`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
window.handleCourseUpdate = async function(event) {
    ...
    try {
        ...
        if (courseId.startsWith('REQ-')) {
            endpoint = `${API_BASE_URL}/api/course-management/requests/${courseId}`;
...
window.handleProfileUpdate = function(event) {
    ...
    console.log('Updating profile:', { adminName, department, employeeId, bio, quote });
