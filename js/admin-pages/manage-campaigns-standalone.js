/**
 * MANAGE CAMPAIGNS - STANDALONE NAVIGATION & PANEL MANAGEMENT
 * Complete standalone script for manage-campaigns.html
...
const ModalManager = {
    modals: {
        ...
        'campaign-details-modal': null,
        'approve-campaign-modal': null,
        'reject-campaign-modal': null
    },
...
window.openCampaignDetailsModal = function(campaignId) {
    ModalManager.openModal('campaign-details-modal');
    console.log('View campaign:', campaignId);
};

window.closeCampaignDetailsModal = function() {
    ModalManager.closeModal('campaign-details-modal');
};

window.openApproveCampaignModal = function(campaignId) {
    ModalManager.openModal('approve-campaign-modal');
    console.log('Approve campaign:', campaignId);
};

window.closeApproveCampaignModal = function() {
    ModalManager.closeModal('approve-campaign-modal');
};

window.openRejectCampaignModal = function(campaignId) {
    ModalManager.openModal('reject-campaign-modal');
    console.log('Reject campaign:', campaignId);
};

window.closeRejectCampaignModal = function() {
    ModalManager.closeModal('reject-campaign-modal');
};

// Sidebar Actions
window.openCampaignGuidelines = function() {
    alert('Campaign Guidelines - Coming soon!');
};

window.openCampaignReports = function() {
    alert('Campaign Reports - Coming soon!');
};
...
// Campaign Actions
window.confirmApproveCampaign = function() {
    console.log('Campaign approved');
    alert('Campaign approved successfully!');
    closeApproveCampaignModal();
};

window.confirmRejectCampaign = function() {
    const reason = document.getElementById('rejectCampaignReason');
    if (reason && !reason.value.trim()) {
        alert('Please provide a reason for rejection');
        return;
    }
    console.log('Campaign rejected:', reason ? reason.value : '');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Manage Campaigns - Standalone Navigation Initialized');
});
