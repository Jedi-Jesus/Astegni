...
(function() {
    ...
    async function loadReviewStats() {
        try {
            ...
            const url = adminId ? `${API_BASE_URL}/api/admin-reviews/stats?admin_id=${adminId}` : `${API_BASE_URL}/api/admin-reviews/stats`;
    ...
    async function loadAllReviews(filters = {}) {
        try {
            ...
            // Build URL with filters and admin_id
            let url = `${API_BASE_URL}/api/admin-reviews/?limit=50&offset=0`;
    ...
    async function loadRecentReviewsWidget() {
        try {
            const adminId = await getAdminId();
            const url = adminId ? `${API_BASE_URL}/api/admin-reviews/recent?limit=5&admin_id=${adminId}` : `${API_BASE_URL}/api/admin-reviews/recent?limit=5`;
