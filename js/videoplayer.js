...
class UltimateVideoPlayer {
    ...
    cacheElements() {
        this.elements = {
            ...
            videoTitle: document.querySelector('.video-title-enhanced'),
            ...
            creatorAvatar: document.querySelector('.creator-avatar'),
    ...
    setupEventListeners() {
        ...
        // Close button
        const closeBtn = document.querySelector('.modal-close-btn-enhanced');
        if (closeBtn) {
        ...
        if (this.elements.descriptionTab && videoData.description) {
            this.elements.descriptionTab.innerHTML = `
                <div class="enhanced-card">
                    <p style="line-height: 1.6;">${videoData.description}</p>
                </div>
            `;
        }
    ...
    async togglePiP() {
        ...
        try {
            ...
            this.showNotification('Picture-in-Picture not supported');
        }
    }
