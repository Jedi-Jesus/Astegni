...
function handleLogin(e) {
    ...
    if (email && password) {
        ...
        APP_STATE.currentUser = { name: 'John Doe', email };
...
function updateUIForLoggedInUser() {
    ...
    const loginButtons = document.querySelectorAll('#login-btn, #register-btn, #hero-login-btn, #hero-register-btn');
...
function socialLogin(platform) {
    ...
    setTimeout(() => {
        APP_STATE.isLoggedIn = true;
        APP_STATE.currentUser = { name: 'Social User', email: 'user@' + platform + '.com' };
        updateUIForLoggedInUser();
        closeModal('login-modal');
